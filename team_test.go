				...
				Players: []soccer.SelectedPlayer{
					{
						...
						Attributes: soccer.PlayerAttributes{
							...
							Positions:       []soccer.PlayerPosition{soccer.PlayerPositionGoalkeeper},
							ControlRating:   80,
							SpeedRating:     80,
						},
					},
					{
						...
						Attributes: soccer.PlayerAttributes{
							...
							Positions:       []soccer.PlayerPosition{soccer.PlayerPositionDefense},
							ControlRating:   80,
							SpeedRating:     80,
						},
					},
					{
						...
						Attributes: soccer.PlayerAttributes{
							...
							Positions:       []soccer.PlayerPosition{soccer.PlayerPositionMidfield},
							ControlRating:   80,
							SpeedRating:     80,
						},
					},
					...
					},
					{
						...
						Attributes: soccer.PlayerAttributes{
							...
							Positions:       []soccer.PlayerPosition{soccer.PlayerPositionAttack},
							ControlRating:   80,
							SpeedRating:     80,
						},
					},
				...
				Players: []soccer.SelectedPlayer{
					{
						SelectedPosition: soccer.PlayerPositionGoalkeeper,
						Attributes: soccer.PlayerAttributes{
							PrimaryPosition: soccer.PlayerPositionAny,
							Positions:       []soccer.PlayerPosition{soccer.PlayerPositionAny},
							ControlRating:   55,
							SpeedRating:     55,
						},
					},
...
func createPlayer(control, speed int, position soccer.PlayerPosition, selectedPosition soccer.PlayerPosition) soccer.SelectedPlayer {
	return soccer.SelectedPlayer{
		...
		Attributes: soccer.PlayerAttributes{
			...
			Positions:       []soccer.PlayerPosition{position},
...
func TestTeam_GetOverallTeamDefenseScore(t *testing.T) {
	tests := map[string]struct {
		...
		"low scoring defenders has smaller overall impact on team defense": {
			...
			wantOverallTeamDefenseScore: 76,
		},
		"with max score": {
			gotTeam: soccer.GameLineup{
				Team: soccer.Team{
